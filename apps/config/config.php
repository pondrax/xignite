...
|
*/
$config['api_secret_key'] = 'XigniteApps';
...
|--------------------------------------------------------------------------
|
| HMVC app folder, default modules is in root path directory
|
*/
...
|--------------------------------------------------------------------------
|
| This option allows you to user spesific controller suffix to prevent model colision. 
| model should look much prettier. ex:
| modules/test/controllers/test_controller.php
| modules/test/models/test.php
|
*/
...
$config['sess_cookie_name'] = 'rand_session';
