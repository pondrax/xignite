...
class MY_Upload extends CI_Upload
{
    ...
    public function data($index = NULL)
    {
        ...
        $app_path=str_replace("\\","/",FCPATH);
        $link_path=(str_replace($app_path,base_url(),$this->upload_path));
        $file_name=str_replace($this->file_ext, '', $this->file_name)
                   .'_'.count($this->uploadedFiles).$this->file_ext;
                        
        // $file_name=$this->conf_name.'_'.$key.$file['file_ext'];
        rename($this->upload_path.$this->file_name,$this->upload_path.$file_name);
        ...
        $data = array(
            ...
            'link_path'		=> $link_path.$this->file_name,
