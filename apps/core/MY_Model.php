...
class MY_Model extends CI_Model{
  ...
  public static function one($criteria=null){
    return self::fetch($criteria,true)[0];
  }
  public static function all($criteria=null){
    return self::fetch($criteria);
  }
  
  public static function table($criteria=null,$deleted_filter='default'){
    return self::fetch_table($criteria,$deleted_filter);
  }
  
  public static function fetch($criteria=null,$one=false){
    self::from();
  ...
  public static function fetch_table($criteria=null,$deleted_filter='default'){
    self::from();
  ...
  ---------------------------------------------------------------------------- */
    ...
    if($data!==false){
      ...
      self::$db->insert(self::_var('table'), $data);
  ...
  public static function search($keyword=null,$fields=null){
    if(!$fields){
      $fields=self::$db->list_fields(self::_var('table'));
    }else{
