        ...
        <div class="row justify-content-center py-5" style="min-height:100vh">
          <div class="col-md-8 pt-5">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-auto mr-1 my-1 border" style="width:80px;height:80px;overflow:hidden;position:relative">
                <embed src="{{$l['url']}}" class="w-100"></embed>
            ...
            <hr>
            <form action="@url/aduan/registrasi" class="" method="post">
