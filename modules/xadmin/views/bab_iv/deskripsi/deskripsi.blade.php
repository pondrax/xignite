<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="#" class="reload-tab" data-title="Deskripsi" data-url="@url/xadmin/bab_iv/deskripsi/view/" data-get="">Deskripsi</a>
    </li>
  </ol>
</nav>
<div data-toolbar>
...
<table class="table" data-table="@_path" data-get="" data-module="table,form" data-access="@_access">
  <thead>
    <tr>
      ...
      <th data-field="instansi" data-format="<b>{instansi}</b>" data-sortable="true" data-width="150">Instansi</th>
      <th data-field="tujuan" data-sortable="true">Tujuan</th>
      <th data-field="permasalahan" data-sortable="true">Permasalahan</th>
      <th data-field="solusi" data-sortable="true">Solusi</th>
      <th data-field="penghargaan" data-sortable="true">Penghargaan</th>
      <th data-title="Aksi" data-events="action" data-formatter='
