<form action="@_path/update/" method="post" enctype="multipart/form-data" class="py-3 mt-3 border-top" novalidate>
  <div class="row pb-2">
    ...
    <div class="col">
      <label>Tujuan</label>
      <textarea class="form-control summernote" name="tujuan" placeholder="Tujuan">{{$data->tujuan|''}}</textarea>
    </div>
    <div class="w-100"></div>
    <div class="col">
    ...
    <div class="col">
      ...
      <textarea class="form-control summernote" name="penghargaan" placeholder="Penghargaan">{{$data->penghargaan|''}}</textarea>
    </div>
  </div>
