<form action="@_path/update/" method="post" enctype="multipart/form-data" class="py-3 mt-3 border-top" novalidate>
  <div class="row pb-2">
    ...
    <div class="col form-group">
      ...
      <input type="text" name="id_kegiatan" class="form-control selectize" placeholder="Pilih Kegiatan" value="{{$data->id_kegiatan|''}}" data-options="daftar_kegiatan">
    </div>
    <div class="w-100"></div>
    <div class="col-6 form-group">
      <label>Indikator</label>
      <textarea class="form-control h-min" name="indikator" placeholder="Indikator Kegiatan" >{{$data->indikator|''}}</textarea>
    </div>
    <div class="col-6">
      <label>Target</label>
      ...
      <div class="form-group input-group mb-3">
        ...
        <input type="text" class="form-control target" placeholder="Target" value="{{get_jumlah($target)}}" onkeyup="kalkulasi()" data-number>
      ...
      <div class="form-group input-group mb-3">
        ...
        <input type="text" class="form-control realisasi" placeholder="Realisasi" value="{{get_jumlah($realisasi)}}" onkeyup="kalkulasi()" data-number>
        <div class="input-group-append pl-1">
...
<script>
  Module.form.setSelectize({
    daftar_kegiatan : {{jsonform($daftar_kegiatan)}}
  });
  function kalkulasi(){
