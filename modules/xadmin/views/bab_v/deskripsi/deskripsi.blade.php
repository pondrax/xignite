<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="#" class="reload-tab" data-title="Deskripsi" data-url="@url/xadmin/bab_v/deskripsi/view/" data-get="">Deskripsi</a>
    </li>
  </ol>
</nav>
@if($pengisi)
...
<table class="table" 
  ...
  <thead>
    <tr>
      ...
      <th data-field="bab" data-sortable="true">Tugas</th>
      <th data-field="instansi" data-format="<b>{instansi}</b>" data-sortable="true">Instansi</th>
      <th data-field="dasar_hukum" data-sortable="true">Dasar Hukum</th>
      <th data-field="permasalahan" data-sortable="true">Permasalahan</th>
      <th data-field="solusi" data-sortable="true" data-visible="false">Solusi</th>
