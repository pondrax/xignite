...
class Laporan_controller extends CI_Controller {
  function __construct() {
    ...
    $this->load->model('xadmin/bab_vi/laporan');
    $this->data=[
      'path'=>base_url('xadmin/bab_vi/laporan'),
  ...
  public function view($json=null,$deleted_filter=false){
    ...
    if($json){
      ...
      $this->load->blade('xadmin/bab_vi/laporan/laporan',$this->data);
    }
  }
  ...
  public function form($mode=''){
    ...
    foreach($data as $i=>$d){
      ...
      $this->data['data']=$d;
      $this->load->blade('xadmin/bab_vi/laporan/laporan.form',$this->data);
    }
  }
